...
function _page($$renderer, $$props) {
  ...
  for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
    ...
    $$renderer.push(
      `<div class="rounded-lg overflow-hidden break-inside-avoid"><img${attr('src', img.src)}${attr('alt', img.alt)} class="w-full h-auto hover:scale-105 transition-transform duration-500" loading="lazy"/></div>`
    );
  }
