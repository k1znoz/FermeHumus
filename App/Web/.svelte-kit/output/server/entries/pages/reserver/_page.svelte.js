import { h as head, e as ensure_array_like, d as escape_html, b as attr, a as attr_class, s as stringify, f as derived } from "../../../chunks/renderer.js";
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`</select></div> <div><label for="booking-children" class="block font-label-caps text-on-surface-variant mb-2 uppercase text-[11px]">Enfants</label> <select id="booking-children" class="w-full bg-surface rounded-lg border-none focus:ring-1 focus:ring-secondary py-3 px-4 font-body-md text-on-surface">`);
    $$renderer2.option({ selected: true }, ($$renderer3) => {
      $$renderer3.push(`0`);
    });
    $$renderer2.option({}, ($$renderer3) => {
