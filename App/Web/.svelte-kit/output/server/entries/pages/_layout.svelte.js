...
function Header($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(
      `<!--]--></nav> <a href="/reserver" class="hidden sm:inline-flex bg-primary text-on-primary px-5 py-2 rounded-lg font-label-caps uppercase tracking-widest hover:opacity-90 active:scale-95 transition-all">Réserver</a></header> `
    );
    {
      $$renderer2.push('<!--[-1-->');
    }
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head('12qhfyh', $$renderer2, ($$renderer3) => {
      ...
      $$renderer3.push(
        `<meta name="description" content="Une agriculture régénératrice au service de la biodiversité et de votre santé. Produits biologiques, séjours à la ferme et marchés locaux."/> <link rel="icon" href="/favicon.png"/> <link rel="apple-touch-icon" href="/favicon.png"/>`
      );
    });
    if (!isAdminRoute()) {
      $$renderer2.push('<!--[0-->');
