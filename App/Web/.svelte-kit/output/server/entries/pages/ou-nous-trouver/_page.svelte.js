import { h as head, e as ensure_array_like, d as escape_html } from "../../../chunks/renderer.js";
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="pt-32 pb-xl px-margin-mobile md:px-0"><div class="max-w-[1140px] mx-auto"><section class="mb-lg text-center md:text-left"><span class="font-label-caps text-secondary uppercase tracking-[0.2em] mb-sm block">Trouver nos produits</span> <h1 class="font-h1 text-h1 text-primary mb-md">Où nous trouver</h1> <p class="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">De la terre à votre table. Retrouvez nos récoltes saisonnières sur les marchés locaux, dans
				nos boutiques partenaires, ou venez nous rendre visite directement à la ferme.</p></section> <section class="grid grid-cols-1 md:grid-cols-12 gap-gutter mb-xl"><div class="md:col-span-8 h-[500px] bg-surface-container-low rounded-xl overflow-hidden relative shadow-ambient border border-outline-variant/20"><img src="https://lh3.googleusercontent.com/aida-public/AB6AXuC5DhhSrmRg6CP6557TErd0P65c552Auxcp2p8dbtA0YKphLRvf8rdwqfiTTKdqdBg1NDukWK279AbMojpyLPLIFJbcTxhCKZv6rTypKxWgNog3FEO57oAHtQfgaEtZ0_9nAWYY032sUbvgD__I2m8GTeL6QPylmX2ZwtDTe2zwQ8l7hQ0fWMcnLa_ExihhrbN5RlLGruJ0euQChs_ACNRo768AZ-sh5AB-sqJqyXyzPdAkZA41jZton8FAVTAwXyB02Swd4gGcLIHT" alt="Carte de la région — Ferme de l'Humus" class="w-full h-full object-cover grayscale-[20%] opacity-90"/> <div class="absolute top-1/4 left-1/3 group cursor-pointer"><div class="bg-secondary text-on-secondary p-2 rounded-full shadow-lg scale-100 group-hover:scale-110 transition-transform"><span class="material-symbols-outlined block" style="font-variation-settings: 'FILL' 1;">location_on</span></div> <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-white px-3 py-1 rounded shadow-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap"><span class="text-xs font-bold text-primary">La Ferme de l'Humus</span></div></div> <div class="absolute bottom-6 right-6 flex flex-col gap-2"><button class="bg-white/90 backdrop-blur p-2 rounded-lg shadow-md text-primary hover:bg-white transition-colors" aria-label="Zoom avant"><span class="material-symbols-outlined">add</span></button> <button class="bg-white/90 backdrop-blur p-2 rounded-lg shadow-md text-primary hover:bg-white transition-colors" aria-label="Zoom arrière"><span class="material-symbols-outlined">remove</span></button></div></div> <div class="md:col-span-4 flex flex-col gap-gutter"><div class="bg-white p-lg rounded-xl shadow-ambient border border-outline-variant/10 flex-1"><h3 class="font-h3 text-h3 text-primary mb-md">Marchés de Semaine</h3> <ul class="space-y-md"><!--[-->`);
    ...
    $$renderer2.push(`<!--]--></ul></div></div></div></section> <section class="grid grid-cols-1 md:grid-cols-2 gap-xl items-center mb-xl"><div class="order-2 md:order-1"><div class="relative rounded-2xl overflow-hidden aspect-video shadow-ambient"><img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBQOuDY-7tfGLhZPorOocO3e0he0D8eLg1GE36ZN3awRW_4Rr_oXaooTTyV-llHFAykX8rY2uaI2pOktNC3dvENV6FVBXMlL1TbPIoRMnzzY_bmnkBx3N36xocVncdmOGFtg5Jh4LY0F-oD2FlPjUuQcuet_UMQ5-T9ztNhlGr0knKIW5wnZ81HeTS3X_5Y6k9_lwr37QvP7W3w15jgbnpfEFLKG5xyvxN8cr3-EZQMxuVn2xM43q6sHh5hoJZD2xd37JMJf_FZ4JXM" alt="Chemin menant à la ferme" class="w-full h-full object-cover"/></div></div> <div class="order-1 md:order-2"><span class="font-label-caps text-secondary uppercase tracking-[0.2em] mb-sm block">Venir à la Ferme</span> <h2 class="font-h2 text-h2 text-primary mb-md">Vente directe &amp; Visites</h2> <p class="font-body-md text-on-surface-variant mb-lg">Nous vous accueillons tous les mercredis après-midi pour la vente directe au hangar.
