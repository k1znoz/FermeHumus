...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/a-propos" | "/admin" | "/admin/harvest" | "/admin/history" | "/admin/login" | "/admin/logout" | "/admin/products" | "/admin/products/new" | "/admin/stock" | "/admin/transform" | "/cgu" | "/cgv" | "/mentions-legales" | "/ou-nous-trouver" | "/politique-de-confidentialite" | "/produits" | "/reserver";
		RouteParams(): {
