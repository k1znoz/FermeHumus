...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/a-propos" | "/admin" | "/admin/harvest" | "/admin/history" | "/admin/login" | "/admin/logout" | "/admin/products" | "/admin/products/new" | "/admin/products/[id]" | "/admin/stock" | "/admin/transform" | "/cgu" | "/cgv" | "/contact" | "/mentions-legales" | "/ou-nous-trouver" | "/politique-de-confidentialite" | "/produits" | "/reserver";
		RouteParams(): {
		...
		Pathname(): "/" | "/a-propos" | "/admin" | "/admin/harvest" | "/admin/history" | "/admin/login" | "/admin/logout" | "/admin/products" | "/admin/products/new" | `/admin/products/${string}` & {} | "/admin/stock" | "/admin/transform" | "/cgu" | "/cgv" | "/contact" | "/mentions-legales" | "/ou-nous-trouver" | "/politique-de-confidentialite" | "/produits" | "/reserver";
