  ...
  {#if selectedCount > 0}
    ...
    >
      ...
      <p class="mb-3 text-xs font-semibold text-[#172c21]">
        {selectedCount} produit{selectedCount > 1 ? 's' : ''} selectionne{selectedCount > 1
          ? 's'
          : ''}
      </p>
        ...
        <div class="rounded-2xl bg-white border border-[#e3e2e0] p-3">
          <div class="flex items-center gap-3">
            ...
            >
              ...
              <div
                class="shrink-0 inline-flex items-center gap-1.5 rounded-xl bg-[#172c21] px-3 py-2 text-white"
              >
                <svg
                  class="h-4 w-4"
                  fill="none"
