...
export const actions = {
  default: async ({ request }) => {
    ...
    if (!smtpUser || !smtpPass) {
      ...
      return fail(500, {
        error:
          "Le service de messagerie n'est pas configuré. Contactez-nous directement à fermehumus@gmail.com.",
      });
    }
    ...
    try {
      ...
      return fail(500, {
        error:
          "Erreur lors de l'envoi du message. Réessayez ou contactez-nous à fermehumus@gmail.com.",
      });
    }
