...
<section class="pt-28 pb-20 px-margin-mobile md:px-lg max-w-[1140px] mx-auto">
  <header class="mb-lg">
    ...
    <p class="font-body-lg text-on-surface-variant max-w-3xl">
      Ce document précise les règles applicables aux ventes de produits et services proposés par
      Ferme de l'Humus.
    </p>
  </header>
    ...
    >
      <article>
        ...
        <p class="font-body-md text-on-surface-variant">
          Les présentes conditions encadrent les ventes de produits et services proposés par Ferme
          de l'Humus.
        </p>
      </article>
      ...
      <article>
        ...
        <p class="font-body-md text-on-surface-variant">
          Les prix sont indiqués en euros TTC. Le règlement s'effectue selon les moyens proposés
          lors du parcours de commande.
        </p>
      </article>
      ...
      <article>
        ...
        <p class="font-body-md text-on-surface-variant">
          Les modalités de retrait à la ferme et de livraison locale sont précisées lors de la
          commande.
        </p>
      </article>
