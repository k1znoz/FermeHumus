...
>
  ...
  <div class="flex items-center gap-4">
    <button
      onclick={toggleMenu}
      class="material-symbols-outlined cursor-pointer hover:opacity-80 transition-colors duration-300 md:hidden {transparent
        ? 'text-white [filter:drop-shadow(0_1px_3px_rgba(0,0,0,0.4))]'
        : 'text-[#2D4236]'}"
      aria-label="Menu"
    >
      menu
